...
namespace Core.Organizer
{
    export class ItemScope
    {
        ...
        constructor( public handle : Element, public instance : Controller<any> | any, public subscriptions : Array<IAction>, public controllers : Map<ControllerNode>, public loops : Map<LoopNode>, public compositions : Map<CompositionNode> )
        {
            // nothing here...
        }
